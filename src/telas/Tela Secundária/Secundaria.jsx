        ...
        <KeyboardAvoidingView style={styles.container} behavior="padding">
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                <View style={styles.imageContainer}>
                    ...
                    <Image
                        source={imagem ? { uri: imagem.uri } : require('../../../res/img/USER.png')}
                        style={styles.image}
                    />
                </View>
                ...
                <View style={styles.buttonContainer}>
                    ...
                    <Button title="Câmera" onPress={handleCameraLaunch} color="black" />
                    {/* Botão para selecionar imagem da galeria na cor azul */}
                    <Button title="Galeria" onPress={handleImageLibraryLaunch} color="black" border/>
                    {/* Botão de enviar na cor vermelha */}
                    <Button title="Enviar" onPress={() => navigation.navigate('Principal')} color="black" />
                </View>
            </ScrollView>
